...
const verificaCidade = cidades.some((cidade) => cidade.nome.includes("Florianópolis"));
console.log(verificaCidade);


const pesquisa = cidades.filter((loc) => loc.nome.toLowerCase() == "florianópolis");
console.log(Boolean (pesquisa));
